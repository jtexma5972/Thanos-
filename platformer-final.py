...
# Fonts
font_xs = load_font("assets/fonts/Demonized.ttf", 16)
font_sm = load_font("assets/fonts/Demonized.ttf", 32)
font_md = load_font("assets/fonts/Demonized.ttf", 48)
font_lg = load_font("assets/fonts/Demonized.ttf", 64)
font_xl = load_font("assets/fonts/thanos.otf", 100)
...
# Images
idle = load_image('assets/images/characters/thanos_idle.png')
walk = [load_image('assets/images/characters/thanos_walk1.png'),
        load_image('assets/images/characters/thanos_walk2.png')]
jump = load_image('assets/images/characters/thanos_jump.png')
hurt = load_image('assets/images/characters/thanos_hurt.png')
...
tile_images = { "Grass": load_image('assets/images/tiles/lava.png'),
                "Dirt": load_image('assets/images/tiles/platformPack_tile007.png'),
                "Platform": load_image('assets/images/tiles/lava.png'),
...
basic_enemy_images = [ load_image('assets/images/characters/iron1.png'),
                       load_image('assets/images/characters/iron3.png') ]

platform_enemy_images = [ load_image('assets/images/characters/cap2.png'),
                          load_image('assets/images/characters/cap3.png') ] 
...
class Game():
    ...
    def show_title_screen(self):
        text = font_xl.render(TITLE, 2, ORANGE)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 200
        screen.blit(text, rect)
        
        text = font_sm.render("Press space to start.", 1, PURPLE)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 272
        screen.blit(text, rect)
    ...
    def show_win_screen(self):
        text = font_lg.render("YOU SAVE THE UNIVERSAL", 1, BLACK)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 144
        screen.blit(text, rect)
    ...
    def show_lose_screen(self):
        text = font_lg.render("MISSON FAIL!TRY AGAIN", 1, BLACK)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 144
        screen.blit(text, rect)
